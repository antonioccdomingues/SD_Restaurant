mkdir -p bin
javac --release 8 -cp genclass.jar commInfra/*.java serverSide/*/*.java -d bin
javac --release 8 -cp genclass.jar commInfra/*.java clientSide/*/*.java -d bin
