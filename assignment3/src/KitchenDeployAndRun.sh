...
sshpass -p "qwerty" scp genclass.jar dirKitchen.zip sd205@l040101-ws02.ua.pt:/home/sd205
echo "Decompressing data sent to the bar node."
sshpass -p "qwerty" ssh sd205@l040101-ws02.ua.pt 'unzip -qo  dirKitchen.zip'
echo "Executing program at the customers node."
sshpass -p "qwerty" ssh sd205@l040101-ws02.ua.pt 'cd dirKitchen ; ./kitchen.sh' 
