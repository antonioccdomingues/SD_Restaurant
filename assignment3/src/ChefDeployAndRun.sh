...
sshpass -p "qwerty" scp genclass.jar dirChef.zip sd205@l040101-ws04.ua.pt:/home/sd205
echo "Decompressing data sent to the bar node."
sshpass -p "qwerty" ssh sd205@l040101-ws04.ua.pt 'unzip -qo dirChef.zip'
echo "Executing program at the customers node."
sshpass -p "qwerty" ssh sd205@l040101-ws04.ua.pt 'cd dirChef ; ./chef.sh' 