...
sshpass -p "qwerty" scp genclass.jar dirStudent.zip sd205@l040101-ws06.ua.pt:/home/sd205
echo "Decompressing data sent to the bar node."
sshpass -p "qwerty" ssh sd205@l040101-ws06.ua.pt 'unzip -qo dirStudent.zip'
echo "Executing program at the customers node."
sshpass -p "qwerty" ssh sd205@l040101-ws06.ua.pt 'cd dirStudent ; ./student.sh' 