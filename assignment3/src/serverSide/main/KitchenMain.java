	   ...
	   */
	   ...
	   public static void main (String[] args)
	   {
	     ...
	     /* instantiate a barber shop object */
	      ...
	      Kitchen kitchen = new Kitchen (reposStub);                 // barber shop object
	      KitchenInterface kitchenStub = null;                          // remote reference to the barber shop object
	     ...
	     /* register it with the general registry service */
	      ...
	      String nameEntryObject = "Kitchen";                   // public name of the barber shop object
